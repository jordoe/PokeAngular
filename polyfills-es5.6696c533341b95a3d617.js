                ...
                { target: 'Array', proto: !0, forced: !f('slice') },
                {
                    slice: function(t, e) {
                        ...
                        if (
                            ...
                            return p.call(v, g, y);
                        for (
                            r = new (void 0 === n ? Array : n)(h(y - g, 0)),
                                f = 0;
                            g < y;
                            g++, f++
                        )
                ...
                return [
                    ...
                    function(t, i) {
                        ...
                        for (var k, x = '', w = 0, _ = 0; _ < b.length; _++) {
                            ...
                            var I = m.groups;
                            if (d) {
                                var j = [E].concat(T, S, v);
                                void 0 !== I && j.push(I);
                                var M = String(i.apply(void 0, j));
                            } else M = r(E, v, S, T, I, i);
                            S >= w &&
                                ((x += v.slice(w, S) + M), (w = S + E.length));
                        }
                        return x + v.slice(w);
                    },
                ];
        ...
        pDpN: function(t, e) {
            !(function(t) {
                    ...
                    u = (function() {
                        function t(t, e, n) {
                            (this._taskCounts = {
                                ...
                                (this._handleErrorZS =
                                    n &&
                                    (n.onHandleError ? n : e._handleErrorZS)),
                                (this._handleErrorDlgt =
                                    n &&
                                    (n.onHandleError ? e : e._handleErrorDlgt)),
                                (this._handleErrorCurrZone =
                                    n &&
                                    (n.onHandleError ? this.zone : e.zone)),
                                (this._scheduleTaskZS =
                                    n &&
                                    (n.onScheduleTask ? n : e._scheduleTaskZS)),
                                ...
                                (this._scheduleTaskCurrZone =
                                    n &&
                                    (n.onScheduleTask ? this.zone : e.zone)),
                                (this._invokeTaskZS =
                                    n &&
                                    (n.onInvokeTask ? n : e._invokeTaskZS)),
                                (this._invokeTaskDlgt =
                                    n &&
                                    (n.onInvokeTask ? e : e._invokeTaskDlgt)),
                                ...
                                (this._cancelTaskDlgt =
                                    n &&
                                    (n.onCancelTask ? e : e._cancelTaskDlgt)),
                    ...
                    s = (function() {
                        ...
                        return (
                            (e.invokeTask = function(t, e, n) {
                                ...
                                try {
                                    return (
                                        t.runCount++, t.zone.runTask(t, e, n)
                                    );
                                } finally {
                                    1 == D && g(), D--;
                                }
                ...
                Zone.__load_patch('ZoneAwarePromise', function(t, e, n) {
                    ...
                    return (
                        (Promise[e.__symbol__('uncaughtPromiseErrors')] = a), R
                    );
                });
            ...
            function kt(t, e) {
                if ((!S || O) && !Zone[t.symbol('patchEvents')]) {
                    ...
                    if (T) {
                        ...
                        mt(
                            i,
                            yt.concat(['messageerror']),
                            r ? r.concat(a) : r,
                            o(i)
                        ),
                            mt(Document.prototype, yt, r),
                            void 0 !== i.SVGElement &&
                                mt(i.SVGElement.prototype, yt, r),
            ...
            c ||
                (T(
                    (U = function() {
                        ...
                        return (
                            a && et && nt(W, e, { configurable: !0, set: n }),
                            rt(e, t)
                        );
                    }).prototype,
                    'toString',
